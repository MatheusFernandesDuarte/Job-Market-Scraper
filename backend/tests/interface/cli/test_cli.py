# backend/tests/interface/cli/test_cli.py
...
def mock_use_case(mocker: MagicMock) -> MagicMock:
    ...
    mock = mocker.patch("backend.src.interface.cli.cli.JobSearchAndEnrichUseCase")
...
def mock_ui(mocker: MagicMock) -> MagicMock:
    ...
    mock = mocker.patch("backend.src.interface.cli.cli.cli_ui")
...
def mock_scraper(mocker: MagicMock) -> MagicMock:
    ...
    return mocker.patch("backend.src.interface.cli.cli.PlaywrightScraper")


@pytest.fixture
def mock_logger_info(mocker: MagicMock) -> MagicMock:
    """Mocks the 'info' method of the logger in the cli module."""
    return mocker.patch("backend.src.interface.cli.cli.logger.info")
