# tests/core/use_cases/test_job_search_and_enrich_use_case.py
...
def mock_initial_filter(mocker: MagicMock) -> MagicMock:
    ...
    return mocker.patch("src.core.use_cases.job_search_and_enrich_use_case.InitialJobFilter.should_keep", return_value=True)


@pytest.fixture
def mock_job_validator(mocker: MagicMock) -> MagicMock:
    """Mocks the JobValidator to always return True."""
    return mocker.patch("src.core.use_cases.job_search_and_enrich_use_case.JobValidator.is_valid", return_value=True)
